      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "¿Qué mensaje físico llevan las sondas Voyager hacia las estrellas? El <span class=\"num\">20 de agosto de 1977</span> se lanzó la primera nave <span class=\"term\">Voyager</span> (sonda espacial estadounidense). El <span class=\"num\">5 de septiembre</span> partió la segunda, ambas hacia el sistema solar exterior. Explorarán de Júpiter a Urano y luego abandonarán el sistema solar como emisarios de la Tierra. A cada una se fijó un disco fonográfico de cobre recubierto de oro.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "Para entender ese gesto, conviene ver primero por qué la humanidad ha querido hablar con el futuro lejano.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'key',
          html: "El <span class=\"key-term\">Disco Voyager</span> es cápsula del tiempo cósmica: ciencia, arte, sonido y saludo reunidos en un artefacto que puede durar mil millones de años.",
        },
        {
          type: 'paragraph',
          html: "Ese disco no nació en el vacío: hereda décadas de intentos humanos de hablar al cosmos.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Si el cosmos puede leer matemáticas, el disco debe enseñar quiénes somos sin suponer contexto terrestre.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "¿Cómo explicar la Tierra a una mente sin contexto previo? El artista y diseñador <span class=\"person\">Jon Lomberg</span> describe cómo seleccionar y codificar <span class=\"num\">118</span> imágenes en el ancho de banda del disco. El reto era pensar como un extraterrestre sin saber nada de nosotros, con apenas seis semanas de plazo.",
        },
        {
          type: 'paragraph',
          html: "El equipo adoptó el ejercicio mental de «ser el extraterrestre». Seis imágenes originales crecieron a más de cien. Drake y Boriakoff redujeron el tiempo de grabación a <span class=\"num\">8</span> segundos por imagen. Colorado Video convirtió las fotos en señal de audio sin costo. Se evitó deliberadamente la guerra y la pobreza. También se excluyeron declaraciones políticas y religión explícita: el mensaje debía sobrevivirnos como lo mejor de la humanidad, no lo peor.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "Tras enseñar con imágenes, el disco añade la voz humana directa en decenas de idiomas.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Después de las palabras humanas, el disco narra la Tierra con sonidos evolutivos.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Si los sonidos cuentan la evolución, la música debe expresar lo que la ciencia no alcanza.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "¿Qué música representa a toda la humanidad en noventa minutos? <span class=\"person\">Timothy Ferris</span> documenta la selección musical del disco, unos <span class=\"num\">87,5</span> minutos enviados a las estrellas. Los criterios fueron amplitud cultural y pasión genuina. El musicólogo <span class=\"person\">Robert Brown</span> lo resumió así: «Si no enviamos lo que nos importa profundamente, ¿para qué enviar nada?»",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'key',
          html: "La <span class=\"key-term\">música del disco</span> expresa lo que la ciencia no alcanza: emociones humanas elegidas con pasión, no por deber protocolario.",
        },
        {
          type: 'paragraph',
          html: "Ese mensaje viaja gracias a una misión científica que primero debe explorar el sistema solar exterior.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Cuando la nave ya parte, queda preguntarse cuánto durará el mensaje que lleva fijado afuera.",
        },
      ],
    },
    {
