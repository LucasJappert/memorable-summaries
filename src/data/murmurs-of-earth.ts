...
export const murmursOfEarth: BookSummary = {
  ...
  toc: [
    ...
    { id: "cap1", num: "01", label: "Para tiempos y seres futuros" },
    { id: "cap2", num: "02", label: "Los cimientos del Disco Voyager" },
    { id: "cap3", num: "03", label: "Imágenes de la Tierra" },
    { id: "cap4", num: "04", label: "Saludos de una Voyager" },
    { id: "cap5", num: "05", label: "Los sonidos de la Tierra" },
    { id: "cap6", num: "06", label: "La música de Voyager" },
    { id: "cap7", num: "07", label: "La misión Voyager al sistema solar exterior" },
    { id: "cap8", num: "08", label: "Epílogo" },
  ...
  sections: [
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "El <span class=\"num\">20 de agosto</span> y el <span class=\"num\">5 de septiembre de 1977</span> se lanzaron dos naves Voyager hacia las estrellas. Tras explorar Júpiter, Saturno y más allá, abandonarán el sistema solar como emisarios de la Tierra. A cada una se fijó un disco fonográfico de cobre recubierto de oro."
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "concept-grid",
          items: [
            { icon: "📻", title: "Disco LP", description: "Frank Drake sugirió un disco: información duradera, imágenes en audio y música." },
            { icon: "🎵", title: "Matemática y música", description: "Relación pitagórica; quizá lenguaje universal para emociones humanas." },
            { icon: "🌍", title: "Público terrestre", description: "Oliver: billones de terrícolas verán el mensaje; casi ningún extraterrestre." }
          ]
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "Drake diseñó el mensaje con ayuda de <span class=\"person\">Carl Sagan</span>. Los números binarios codifican longitudes; los caracteres forman una imagen que un receptor inteligente podría decodificar. La portada del Disco Voyager repite esta lógica: instrucciones científicas para reproducir el registro."
        },
        {
          type: "key",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "list",
          items: [
            "<strong>Apertura matemática</strong> — Números, operaciones y unidades como diccionario para imágenes posteriores.",
            "<strong>Biología y química</strong> — Estructura del ADN, células, anatomía.",
            "<strong>Civilización</strong> — Ciudades, transporte, comida, familia, ciencia."
          ]
        },
        {
          type: "key",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "<span class=\"person\">Linda Salzman Sagan</span> coordinó los saludos hablados: más festivo que un simple «hola», más triste que un suspiro. El reto burocrático de la ONU casi impidió el proyecto; al final, delegados del Comité del Espacio Exterior grabaron mensajes —a menudo demasiado largos."
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "big-numbers",
          items: [
            { value: "54+", label: "Idiomas humanos en el Disco" },
            { value: "1", label: "«Idioma» de ballena jorobada" },
            { value: "118", label: "Fotografías codificadas en el registro" }
          ]
        },
        {
          type: "key",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "<span class=\"person\">Timothy Ferris</span> documenta la selección musical: «los mayores éxitos de la Tierra». Criterios: representatividad cultural, profundidad emocional y coherencia con el resto del mensaje. Bach y Beethoven representan la tradición occidental que lanzó la nave; Lomax amplió con música étnica global."
        },
        {
          type: "paragraph",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Al ver la llama final del cohete Titan partir de Cabo Cañaveral, Sagan contempló el destino del Disco. Fijado al exterior de la nave, enfrenta rayos cósmicos, radiación solar y —principalmente— micrometeoritos."
        },
        {
          type: "paragraph",
          html: "A ~<span class=\"num\">15 km/s</span>, partículas del tamaño de polvo de cometa pueden picar el registro. Sin la cubierta de aluminio, ~<span class=\"num\">10 %</span> del disco podría dañarse en un año-luz. La funda de <span class=\"num\">0,08 cm</span> protege contra micrometeoritos más masivos que ~<span class=\"num\">5 μg</span>."
        },
        {
          type: "paragraph",
  ...
  keyConcepts: [
    { title: "Disco de las Voyager", description: "Registro fonográfico de cobre/dorado con sonido, imágenes y saludos; instrucciones en la cubierta." },
    { title: "Mensaje de Arecibo", description: "Bitmap de 551 caracteres transmitido por radio en 1974; prueba de mensajería SETI." },
    { title: "Cápsula del tiempo", description: "Comunicación con el futuro lejano; tradición desde Esarhaddon hasta la era espacial." },
    { title: "SETI", description: "Búsqueda de inteligencia extraterrestre; escuchar es más plausible que dialogar a distancias interestelares." },
    { title: "Micrometeoritos", description: "Principal amenaza al Disco en el vacío; la cubierta de aluminio mitiga el daño." },
    { title: "Lingua cosmica", description: "Código basado en matemática y física para comunicar sin idioma compartido." },
    { title: "Música como emoción", description: "Lo que la ciencia no transmite: sentimientos humanos codificados en armonía." }
  ],
  chronology: [
    { year: "1971–72", text: "Lanzamiento de Pioneer 10 y 11 con placas interestelares." },
    { year: "1974", text: "Mensaje de Arecibo; satélite LAGEOS con placa de deriva continental." },
    { year: "1976", text: "John Casani encarga a Sagan el mensaje Voyager." },
    { year: "1977", text: "Lanzamiento de Voyager 1 (5 sep) y 2 (20 ago); disco completado en mayo–junio." },
    { year: "1979–81", text: "Voyager explora Júpiter y Saturno; posible ruta a Urano." },
    { year: "1978", text: "Publicación de «Murmurs of Earth»." }
  ],
  figures: [
    { name: "Carl Sagan", role: "Coordinador del proyecto; ensayos sobre tiempo, misión y epílogo." },
    { name: "Frank Drake", role: "SETI y mensaje de Arecibo; sugirió el disco fonográfico." },
    { name: "Jon Lomberg", role: "Diseño y selección de las 118 imágenes codificadas." },
    { name: "Linda Salzman Sagan", role: "Saludos en decenas de idiomas y coordinación ONU." },
    { name: "Ann Druyan", role: "«The Sounds of Earth» y producción creativa del registro." },
    { name: "Timothy Ferris", role: "Selección musical y asistencia en saludos de la ONU." },
    { name: "John Casani", role: "Director del proyecto Voyager en JPL; encargó el mensaje." },
    { name: "Alan Lomax", role: "Asesoría en música étnica mundial para el Disco." }
  ],
  closing: {
