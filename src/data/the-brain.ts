...
export const theBrain: BookSummary = {
  ...
  toc: [
    { id: "prefacio", num: "00", label: "Introducción" },
    { id: "cap1", num: "01", label: "¿Quién soy yo?" },
    { id: "cap2", num: "02", label: "¿Qué es la realidad?" },
    { id: "cap3", num: "03", label: "¿Quién manda?" },
    { id: "cap4", num: "04", label: "¿Cómo decido?" },
    { id: "cap5", num: "05", label: "¿Te necesito?" },
    { id: "cap6", num: "06", label: "¿Quiénes seremos?" },
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "Raramente hablamos del cerebro en la cultura popular; Eagleman lo interpreta como pista: estamos tan atrapados dentro de nuestra realidad que cuesta notar la trampa. Damos por hecho que los colores existen «afuera», que la memoria es como una cámara de video y que conocemos las razones reales de nuestras creencias."
        },
        {
          type: "key",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Todas las experiencias —desde una conversación hasta la cultura que te rodea— moldean los detalles microscópicos del cerebro. Neuronalmente, quién eres depende de dónde has estado. El cerebro es un <span class=\"term\">livewire</span> (cableado vivo): reescribe su propia circuitería; la identidad es un blanco en movimiento que nunca alcanza un punto final."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          html: "Los humanos nacen <span class=\"term\">inacabados</span>: dependemos años de cuidadores mientras el cerebro se moldea por experiencia. A los dos años hay más de <span class=\"num\">100 billones</span> de sinapsis —el doble que en la adultez—; luego la <span class=\"term\">poda neuronal</span> elimina conexiones no usadas. Te conviertes en quien eres no por lo que crece, sino por lo que se elimina."
        },
        {
          type: "concept-grid",
          items: [
            { icon: "🧒", title: "Cerebro livewire", description: "Genes dan planos generales; la experiencia afina el cableado detallado." },
            { icon: "✂️", title: "Poda sináptica", description: "~50 % de sinapsis infantiles se recortan; «lo que no usas, lo pierdes»." },
            { icon: "🏚️", title: "Huérfanos de Rumanía", description: "Privación temprana daña el cerebro; la recuperación es mejor antes de los dos años." }
          ]
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "<span class=\"person\">Mike May</span> recuperó la vista tras más de <span class=\"num\">40</span> años de ceguera: los ojos funcionaban, pero el cerebro no «veía». Solo el gatito que caminaba —no el que iba en góndola— desarrolló visión normal (<span class=\"person\">Held</span> y <span class=\"person\">Hein</span>, <span class=\"num\">1963</span>). Ver exige entrenar cuerpo y sentidos juntos."
        },
        {
          type: "big-numbers",
          items: [
            { value: "~⅓", label: "Cerebro humano dedicado a visión" },
            { value: "~160 ms", label: "Reacción a disparo de pistola (vs. ~190 ms a flash)" },
            { value: "10×", label: "Conexiones corteza→tálamo vs. tálamo→corteza visual" }
          ]
        },
        {
          type: "paragraph",
          html: "Gafas de prisma invierten izquierda y derecha: en minutos provocan náusea; tras una semana el cerebro re-mapea el espacio. El cerebro sincroniza sentidos con retraso: vives en el pasado para que todo parezca simultáneo. En el «Hole» de Alcatraz, sin luz ni sonido, el <span class=\"term\">modelo interno</span> sigue generando imágenes vívidas."
        },
        {
          type: "key",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Actos simples —reconocer un rostro, conducir, entender un chiste— requieren cálculos masivos bajo el umbral de la conciencia. ¿Quién conduce el barco si la mayor parte del trabajo es invisible?"
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          html: "La <span class=\"term\">propiocepción</span> —saber dónde están las partes del cuerpo— puede fallar (síndrome de miembro fantasma, «mano extraña»). Las ondas cerebrales pasan de complejidad despierta a sincronía en sueño profundo: la conciencia emerge de ritmos neuronales integrados."
        },
        {
          type: "concept-grid",
          items: [
            { icon: "👑", title: "Monarca caído", description: "La conciencia resume lo ya decidido en coaliciones neuronales." },
            { icon: "✂️", title: "Cerebro dividido", description: "Dos hemisferios con agendas parcialmente independientes." },
            { icon: "🌊", title: "Ondas y sueño", description: "Conciencia = conversaciones neuronales complejas; sueño = ola mexicana sincronizada." }
          ]
        },
        {
          type: "key",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "Neuronas <span class=\"term\">espejo</span> y circuitos de empatía nos permiten simular estados ajenos. La soledad crónica daña salud como el tabaquismo; la interacción social es neuroquímica —oxitocina, dopamina— no lujo opcional."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          html: "El estudio de órdenes religiosas (<span class=\"person\">David Bennett</span>, Rush University) reveló que reserva cognitiva —actividad mental, redes sociales, propósito— puede compensar patología de Alzheimer en autopsia."
        },
        {
          type: "key",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "La microscopía electrónica serial y el <span class=\"term\">conectoma</span> —mapa de todas las conexiones— avanzan en ratones y humanos. Subir cerebros completos a silicio sigue siendo especulativo, pero la tendencia es clara: la frontera entre máquina y mente se difumina."
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "timeline",
          items: [
            { year: "1963", text: "Experimento de gatitos Held/Hein: visión requiere movimiento propio." },
            { year: "1966", text: "Caso Charles Whitman: tumor y agresión." },
            { year: "2015", text: "Publicación de este libro y serie documental asociada." }
          ]
        },
        {
          type: "key",
  ...
  keyConcepts: [
    { title: "Livewire", description: "Cerebro humano cableado por experiencia, no preprogramado como la mayoría de mamíferos." },
    { title: "Modelo interno", description: "Predicción cerebral que compara expectativas con datos sensoriales (error = actualización)." },
    { title: "Poda sináptica", description: "Eliminación de conexiones no usadas; escultura de la identidad desde la infancia." },
    { title: "Conciencia tardía", description: "La experiencia consciente llega después de preparación neural inconsciente." },
    { title: "Cerebro dividido", description: "Hemisferios con agendas parciales tras sección del cuerpo calloso." },
    { title: "Reserva cognitiva", description: "Redes neuronales alternativas que compensan daño por envejecimiento." },
    { title: "Conectoma", description: "Mapa completo de conexiones neuronales; frontera de la neurociencia futura." },
    { title: "Neuronas espejo", description: "Circuitos que simulan acciones y estados ajenos; base de empatía social." }
  ],
  chronology: [
    { year: "1963", text: "Held y Hein demuestran que la visión normal exige movimiento corporal activo." },
    { year: "1966", text: "Matanza en la Torre de Texas; autopsia revela tumor en amígdala de Whitman." },
    { year: "1967", text: "Yarbus registra movimientos oculares al contemplar cuadros." },
    { year: "1973", text: "Loftus muestra cómo preguntas sugerentes distorsionan memoria de accidentes." },
    { year: "1994", text: "Inicia el Religious Orders Study sobre envejecimiento cerebral." },
    { year: "2015", text: "Eagleman publica «The Brain: The Story of You»." }
  ],
  figures: [
    { name: "David Eagleman", role: "Neurocientífico y autor; guía la exploración popular del cerebro." },
    { name: "Mike May", role: "Recuperó la vista tras décadas de ceguera; demuestra que ver ≠ ojos sanos." },
    { name: "Elizabeth Loftus", role: "Pionera en memoria malleable y recuerdos implantados." },
    { name: "Charles Whitman", role: "Caso extremo: lesión cerebral y cambio de personalidad violenta." },
    { name: "Richard Held y Alan Hein", role: "Experimento de gatitos en cilindro rayado (MIT, 1963)." },
    { name: "Benjamin Libet", role: "EEG y el retraso de la conciencia respecto a la preparación motora." },
    { name: "Francis Crick", role: "Colaborador de Eagleman; buscaba el «significado» en la neurociencia." }
  ],
  closing: {
    title: "La idea central",
    lines: [
      "Eres el producto de un órgano que nunca deja de reescribirse.",
      "La identidad no es un núcleo inmutable sino un patrón neural único, moldeado por cada experiencia.",
      "La conciencia es la punta visible de operaciones masivas que ya decidieron antes de que «tú» lo sepas.",
