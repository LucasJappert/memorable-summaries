...
export const biggestIdeasUniverse: BookSummary = {
  ...
  sections: [
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "La dinámica estudia cambios que obedecen ecuaciones físicas. El modelo «bola en colina» — partícula sin fricción en un paisaje de energía potencial V(x) — reaparece hasta en campos cuánticos."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          html: "El <span class=\"term\">espacio de fases</span> {posición, momento} fija la evolución. Alternativamente, el <span class=\"term\">principio de mínima acción</span> (Lagrange): entre dos eventos, la trayectoria real minimiza la acción S = ∫(K − V)dt — formulación global equivalente a Newton."
        },
        {
          type: "concept-grid",
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "El espacio es <span class=\"term\">tridimensional</span>: tres direcciones independientes (adelante/atrás, izquierda/derecha, arriba/abajo). En d dimensiones, fuerzas como gravedad siguen ley 1/r^(d−1); en 3D, ley del inverso del cuadrado."
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "La mecánica clásica es <span class=\"term\">reversible</span>: con el estado actual se predice futuro y pasado por igual. Sin embargo, macroscópicamente el hielo se derrite y no vuelve a formarse — la <span class=\"term\">flecha del tiempo</span>."
        },
        {
          type: "paragraph",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Einstein necesitó <span class=\"term\">geometría riemanniana</span> para curvar el espaciotiempo. Euclides axiomatizó el plano; el quinto postulado (paralelas) puede reemplazarse → geometrías esférica (curvatura +) e hiperbólica (−)."
        },
        {
          type: "paragraph",
          html: "Gauss y <span class=\"person\">Riemann</span> desarrollaron geometría <span class=\"term\">intrínseca</span>: medible desde dentro, sin embedding en espacio mayor. Un <span class=\"term\">variedades</span> (manifold) es un conjunto de puntos con dimensión definida; zoom infinitesimal → parece plano euclídeo."
        },
        {
          type: "paragraph",
          html: "El <span class=\"term\">tensor métrico</span> g_ij codifica toda la geometría via elemento de línea ds² = g_ij dx^i dx^j. Tensores generalizan funciones y vectores; contracciones con métrica e inversa definen productos internos y curvatura."
        },
        {
          type: "list",
          items: [
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Gravedad = curvatura del espaciotiempo. La ecuación de Einstein (<span class=\"num\">25 nov 1915</span>) relaciona tensor de Einstein (curvatura) con tensor energía-momento (materia): «el espaciotiempo dice a la materia cómo moverse; la materia dice al espaciotiempo cómo curvarse» (<span class=\"person\">Wheeler</span>)."
        },
        {
          type: "paragraph",
  ...
  closing: {
    ...
    lines: [
      ...
      "Entender las ecuaciones es la forma auténtica de conocer el universo",
