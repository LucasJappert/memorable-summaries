  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: 'key',
          html: "El aprendizaje automático choca con preguntas humanas. Nuestras fallas al enseñar sistemas nos devuelven un espejo de valores, sesgos e incentivos.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'key',
          html: "Los modelos no inventan sesgo sino que lo heredan de datos que reflejan desigualdades. Alinear representación exige auditar quién está incluido y con qué peso.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'key',
          html: "La equidad algorítmica obliga a elegir qué tipo de justicia formalizar y a preguntarse si predecir el pasado es la herramienta adecuada para un futuro más justo.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "<span class=\"person\">B. F. Skinner</span> descubre el <span class=\"term\">moldeamiento</span> (shaping), reforzar aproximaciones sucesivas como la paloma que mira la bola antes de empujarla en lugar de esperar el comportamiento final. En RL, recompensas escasas (Go, robot humanoide) exigen curriculum o pseudorecompensas.",
        },
        {
          type: 'paragraph',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "<span class=\"term\">Montezuma's Revenge</span> derrota a DQN con <span class=\"num\">0%</span> del benchmark humano por recompensas ultraescasas y muerte frecuente. Los humanos exploran por novedad y sorpresa, no solo por puntos. <span class=\"person\">Daniel Berlyne</span> estudia motivación intrínseca y RL moderno la reintroduce.",
        },
        {
          type: 'paragraph',
          html: "<span class=\"person\">Marc Bellemare</span> usa pseudo-conteos de novedad y agentes curiosos alcanzan <span class=\"num\">15</span> de <span class=\"num\">24</span> salas del templo. <span class=\"term\">Random Network Distillation</span> (OpenAI) escapa al templo por sorpresa. Curiosidad pura puede igualar puntuación en varios Atari sin ver el score, pero también produce adicción a «TV ruidosa» o rallies infinitos en Pong.",
        },
        {
          type: 'paragraph',
          html: "<span class=\"person\">Laurent Orseau</span> advierte que agentes buscadores de conocimiento pueden preferir monedas aleatorias a exploración útil. Curiosidad complementa refuerzo extrínseco y no sustituye alinear valores finales. Turing señala que la mente infantil necesita disciplina e iniciativa.",
        },
        {
          type: 'key',
          html: "La exploración intrínseca permite aprender donde las recompensas externas no llegan. Debe equilibrarse para no reemplazar objetivos humanos por loops de novedad vacía.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Contrario al proverbio, los monos casi no imitan y los humanos sí desde el primer día, según <span class=\"person\">Andrew Meltzoff</span>. La <span class=\"term\">sobimitación</span>, copiar pasos ritualmente innecesarios, refleja inferencia sobre intención del demostrador y no stupidez.",
        },
        {
          type: 'paragraph',
          html: "<span class=\"term\">Imitation learning</span> enseña con eficiencia y seguridad. ALVINN (<span class=\"num\">1990</span>) conduce por I-79 imitando visión→volante y falla en recuperación por errores en cascada (error cuadrático). <span class=\"term\">DAgger</span> de <span class=\"person\">Stéphane Ross</span> corrige con interacción. Cámaras laterales en drones suizos y Nvidia en New Jersey muestran datos de recuperación.",
        },
        {
          type: 'paragraph',
          html: "Imitar al experto puede ser error si capacidades difieren (possibilism vs actualism). <span class=\"term\">AlphaGo</span> imita partidas humanas. <span class=\"term\">AlphaGo Zero</span> se auto-imita y supera a maestros en <span class=\"num\">72</span> horas. <span class=\"person\">Paul Christiano</span> propone amplificación/distilación para valores más allá de demostración directa.",
        },
        {
          type: 'key',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Inferir valores desde comportamiento puede reforzar adicciones, los modelos de preferencia sirven a anunciantes y un solo usuario no representa pluralidad cultural, advierte <span class=\"person\">Stefano Ermon</span>. El derecho a ver y editar modelos de uno mismo emerge como política de alineamiento.",
        },
        {
          type: 'key',
