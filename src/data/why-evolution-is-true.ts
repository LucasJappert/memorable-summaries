  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Antes de ver las pruebas, necesitamos entender qué dice exactamente la teoría evolutiva moderna.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "La naturaleza parece diseñada. Camaleones, colibríes y orquídeas sugieren un relojero celestial. <span class=\"person\">William Paley</span> escribió en <span class=\"num\">1802</span> que un reloj implica un relojero. La complejidad biológica, decía, implica un Diseñador. Darwin ofreció la respuesta de la <span class=\"term\">evolución</span> y la <span class=\"term\">selección natural</span>.",
        },
        {
          type: 'paragraph',
          html: "La teoría moderna tiene seis piezas. La primera es la evolución misma: cambio genético en poblaciones a través del tiempo. La segunda es el <span class=\"term\">gradualismo</span>: los cambios grandes son la suma de muchos cambios pequeños a lo largo de miles o millones de generaciones. La tercera es la <span class=\"term\">especiación</span>: los linajes se separan y dejan de intercambiar genes.",
        },
        {
          type: 'paragraph',
          html: "La cuarta pieza es la <span class=\"term\">ascendencia común</span>. Todos los seres vivos compartimos ancestros. La quinta es la selección natural, el mecanismo principal. La sexta son mecanismos menores, como la deriva génica. En ciencia, \"teoría\" no significa conjetura. La evolución es marco verificable, hecho y teoría a la vez, como la gravedad.",
        },
        {
          type: 'paragraph',
          html: "La selección natural no es un diseñador consciente. Es un chapucero que remodela lo existente. Produce el más apto, no el óptimo. El rinoceronte indio tiene un solo cuerno porque la mutación de dos quizá nunca surgió. La evolución puede ocurrir sin selección natural, pero solo la selección produce adaptación.",
        },
        {
          type: 'concept-grid',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "La historia de la vida está escrita en fósiles. Es un museo desgarrado pero legible. Paleontólogos como <span class=\"person\">Paul Sereno</span> arriesgan el Sahara para descubrir especies que reescriben la evolución de los dinosaurios. Aun sin fósiles, inferiríamos relaciones por anatomía y ADN.",
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Los organismos son <span class=\"term\">palimpsestos</span> evolutivos. Son como manuscritos medievales reescritos: trazas del texto original persisten. <span class=\"person\">Theodosius Dobzhansky</span> afirmó que nada en biología tiene sentido excepto a la luz de la evolución.",
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "La <span class=\"term\">biogeografía</span> estudia dónde viven las especies. Fue crucial para Darwin en el _Beagle_. Ocupa dos capítulos del _Origen_. Los creacionistas no han refutado seriamente esta evidencia. Simplemente la ignoran.",
        },
        {
          type: 'paragraph',
          html: "Desiertos similares en continentes distintos albergan suculentas no emparentadas. En América hay cactus. En el Viejo Mundo hay euforbias. Es un caso de <span class=\"term\">convergencia</span>: ambientes parecidos moldean linajes independientes en formas similares. No es diseño repetido.",
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "La <span class=\"term\">selección natural</span> esculpe adaptaciones. El avispón gigante asiático ataca colmenas de abejas europeas introducidas. Las abejas europeas no tienen defensa. No coevolucionaron con el depredador. Eso es exactamente lo que predice la evolución: la adaptación es local.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "Los experimentos confirman el mecanismo. Lentejas desarrollan resistencia a herbicidas. <span class=\"person\">Drosophila</span> se adapta al frío o al calor. La complejidad irreducible alegada por el diseño inteligente se desmonta caso por caso. La naturaleza es \"roja en diente y garra\". La crueldad del parasitismo también es producto evolutivo.",
        },
        {
          type: 'key',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "La cola del pavo es pesada, llamativa y costosa. Parece refutar la evolución. A Darwin le \"enfermaba\" contemplarla. La clave es que la moneda de la selección no es solo la supervivencia. Es la <span class=\"term\">reproducción exitosa</span>.",
        },
        {
          type: 'paragraph',
          html: "La <span class=\"term\">selección sexual</span> opera de dos maneras. Primero, los machos compiten entre sí. Las cornamentas del alce irlandés y los harenes de elefantes marinos son ejemplos. Segundo, las hembras eligen pareja. La cola del pavo, los cantos y los bowers de las aves constructoras son productos de esa elección.",
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Darwin tituló su libro _El origen de las especies_. No obstante, sin genética no explicó bien las barreras reproductivas. La comprensión moderna maduró en la década de <span class=\"num\">1930</span> con <span class=\"person\">Ernst Mayr</span> y Theodosius Dobzhansky.",
        },
        {
          type: 'paragraph',
          html: "El <span class=\"term\">concepto biológico de especie</span> define especie como un grupo de poblaciones que se cruzan entre sí. Ese grupo está reproductivamente aislado de otros grupos. Las barreras pueden ser ecológicas, temporales, conductuales o genéticas. Las mulas estériles son un ejemplo. Mayr encontró que nativos de Nueva Guinea nombraban <span class=\"num\">136</span> tipos de aves. Los ornitólogos nombraban <span class=\"num\">137</span>. Las discontinuidades de la naturaleza son reales.",
        },
        {
          type: 'paragraph',
          html: "La <span class=\"term\">especiación alopátrica</span> domina el registro. Poblaciones separadas geográficamente divergen. Con el tiempo pierden compatibilidad. Gambas a ambos lados del istmo de Panamá y mimulos con polinizadores distintos lo muestran. La especiación es un accidente evolutivo. No es una meta de llenar nichos.",
        },
        {
          type: 'paragraph',
