  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Los árboles filogenéticos muestran relaciones anidadas: los vertebrados comparten columna, los reptiles y mamíferos comparten huevo amniótico, y los mamíferos tienen pelo y leche. Esta jerarquía natural predató a Darwin, quien explicó por qué existe: la divergencia por descendencia con modificación.",
        },
        {
          type: 'concept-grid',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Formarse fósiles requiere enterramiento rápido en sedimentos, y los tejidos blandos casi nunca fossilizan. De entre <span class=\"num\">17 millones</span> y <span class=\"num\">4 mil millones</span> de especies estimadas, conocemos ~<span class=\"num\">250.000</span> fósiles, una muestra pequeña pero suficiente. Geólogos creacionistas ordenaron capas por <span class=\"term\">superposición</span> (<span class=\"person\">Nicolaus Steno</span>, s. XVII) antes del darwinismo.",
        },
        {
          type: 'paragraph',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "La <span class=\"term\">biogeografía</span>, el estudio de dónde viven las especies, fue crucial para Darwin en las islas Galápagos y en todo su viaje en el *Beagle*. Especies similares habitan regiones próximas, y las islas oceánicas tienen fauna endémica emparentada con continentes vecinos.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "Fósiles de la misma edad en continentes separados muestran formas emparentadas, lo que prueba conexiones terrestres pasadas (Pangea, puentes de tierra) o dispersión oceánica. La geología y la biología convergen en una narrativa temporal única.",
        },
        {
          type: 'key',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "La <span class=\"term\">selección natural</span> explica adaptaciones asombrosas. El avispón gigante asiático masacra colmenas europeas, pero las abejas nativas de Japón forman una bola caliente a <span class=\"num\">117 °F</span> y «cocinan» al explorador en <span class=\"num\">20 minutos</span>.",
        },
        {
          type: 'paragraph',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "La reproducción sexual parece costosa, porque solo la mitad de los genes pasan y hay que encontrar pareja, pero domina la vida multicelular. ¿Por qué? Porque mezcla genes y permite respuesta rápida a parásitos y cambio ambiental.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "El sexo genera variación sobre la cual actúa la selección. Las especies asexuales, privadas de reproducción sexual, acumulan mutaciones deleterias (declive de Muller) y quedan vulnerables a enfermedades. La paradoja del sexo sigue activa, pero la evidencia favorece ventajas evolutivas claras.",
        },
        {
          type: 'key',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Los humanos no estamos fuera de la evolución. Compartimos ~<span class=\"num\">98–99 %</span> del ADN con chimpancés, y los fósiles documentan la transición de *Australopithecus* a *Homo*, con aumento cerebral, bipedestación y uso de herramientas.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "La genética poblacional muestra que la raza humana es un continuo genético, no categorías discretas. Somos una especie joven (~<span class=\"num\">200.000</span>–<span class=\"num\">300.000</span> años) con poca diversidad genética comparada con otros primates, resultado de cuello de botella y expansión reciente.",
        },
        {
          type: 'key',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Coyne cierra reafirmando que la evolución es tan cierta como cualquier hecho científico. No depende de fe, sino de evidencia convergente de fósiles, biogeografía, genética, anatomía comparada y experimentos de laboratorio (por ejemplo, evolución de bacterias resistentes en tiempo real).",
        },
        {
          type: 'paragraph',
          html: "Los «agujeros» alegados por creacionistas (origen de la vida, detalles de algunas transiciones) no invalidan el núcleo darwiniano. La ciencia progresa llenando vacíos, y el diseño inteligente no predice ni explica nada testeable.",
        },
        {
          type: 'paragraph',
