...
export const blindWatchmaker: BookSummary = {
  ...
  toc: [
    ...
    { id: 'cap1', num: '01', label: 'Explicar lo muy improbable' },
    { id: 'cap2', num: '02', label: 'Buen diseño' },
    { id: 'cap3', num: '03', label: 'Acumulando pequeños cambios' },
    { id: 'cap4', num: '04', label: 'Trazando rutas por el espacio animal' },
    { id: 'cap5', num: '05', label: 'El poder y los archivos' },
    { id: 'cap6', num: '06', label: 'Orígenes y milagros' },
    { id: 'cap7', num: '07', label: 'Evolución constructiva' },
    { id: 'cap8', num: '08', label: 'Explosiones y espirales' },
    { id: 'cap9', num: '09', label: 'Desinflando el punctuationismo' },
    { id: 'cap10', num: '10', label: 'El único árbol verdadero de la vida' },
    { id: 'cap11', num: '11', label: 'Rivales condenados' },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: 'list',
          items: [
            '<strong>Pregunta 1</strong> — Un salto directo de «sin ojo» a ojo humano es estadísticamente imposible.',
            '<strong>Pregunta 2</strong> — De un vecino inmediato en el espacio morfológico, sí es plausible en un paso.',
            '<strong>Pregunta 5</strong> — Cada intermediario debe ser funcional; la selección no espera perfección futura.',
          ],
        },
        {
          type: 'key',
