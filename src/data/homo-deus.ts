...
export const homoDeus: BookSummary = {
  ...
  sections: [
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Harari, tras explicar en <span class=\"term\">Sapiens</span> cómo la especie conquistó la Tierra, proyecta el futuro del mañana: ¿qué ocurre cuando las nuevas tecnologías otorgan poderes casi divinos, creativos y destructivos, y elevan la vida a otra etapa evolutiva?",
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "Por primera vez mueren más personas por comer demasiado que por comer poco. También mueren más por vejez que por epidemias, y más por suicidio que por soldados, terroristas y criminales juntos. Si esos tres enemigos quedan contenidos, la pregunta urgente es otra: ¿qué queremos <span class=\"term\">ser</span> con el poder de la biotecnología y la informática?",
        },
        {
          type: 'big-numbers',
          items: [
            {
              "value": "~15%",
              "label": "Población de Francia que murió de hambre (1692–94)"
            },
            {
              "value": "2.100 M",
              "label": "Personas con sobrepeso (2014) vs. 850 M con subnutrición"
            },
            {
              "value": "~1%",
            ...
            {
              "value": "3 M",
              "label": "Muertes por obesidad (2010) vs. 1 M por hambre"
            }
          ],
        },
        {
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Los humanos llevan siglos siendo dioses para otros animales, poco justos ni misericordiosos. Hoy el planeta está poblado sobre todo por humanos y sus <span class=\"term\">domesticados</span>: ~400 M perros frente a ~200.000 lobos salvajes, y más gallinas que águilas.",
        },
        {
          type: 'big-numbers',
          items: [
            ...
            {
              "value": "70.000 a",
              "label": "Inicio del <span class=\"term\">Antropoceno</span>: sapiens como fuerza ecológica global"
            },
            {
              "value": "~50%",
        ...
        },
        {
          ...
          items: [
            {
              "title": "Trato agrícola",
              "description": "Dioses/teísmo legitimaron la agricultura tradicional; el humanismo legitimó la granja industrial.",
              "icon": "🌾"
            },
            {
              "title": "Analogía futura",
              "description": "Cómo tratamos animales modela cómo superinteligencias podrían tratarnos.",
              "icon": "🤖"
            },
            {
              "title": "Algoritmo",
              "description": "Organismos procesan datos sensoriales con algoritmos bioquímicos; emociones son cálculos de probabilidad evolutiva.",
              "icon": "🧬"
            }
          ],
        },
          ...
          items: [
            {
              ...
              "description": "Objetiva (árboles), subjetiva (miedo), intersubjetiva (leyes, dinero).",
              "icon": "📜"
            },
            {
              "title": "Historia vs biología",
              "description": "Biología no explica sola cruzadas o Corea; las ficciones tienen poder real.",
              "icon": "🏛️"
            },
            {
              "title": "Dilema moral",
              "description": "Sin chispa mágica, ¿qué justifica privilegiar al humano sobre cerdo o IA?",
              "icon": "⚖️"
            }
          ],
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              "title": "Keims vs demonios",
              "description": "Para el vudú los demonios son naturales; lo «sobrenatural» depende del marco.",
              "icon": "🦠"
            },
            {
              "title": "Hexenjagd",
              "description": "Europa del s. XVII: guerras de religión y ciencia conviven.",
              "icon": "⚔️"
            },
            {
              "title": "Pacto",
              "description": "Modernidad = acuerdo entre método científico e ideología humanista.",
              "icon": "🤝"
            }
          ],
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          html: "El crecimiento infinito chocaba con recursos finitos hasta que la ciencia prometió energía y materiales ilimitados (ej. energía solar frente a petróleo finito). El capitalismo santificó la codicia y el desequilibrio. Sorprendentemente redujo hambruna, peste y guerra en dos siglos mejor que milenios de teología.",
        },
        {
          type: 'paragraph',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "El liberalismo descansa en el <span class=\"term\">libre albedrío</span> como hecho, no solo como valor moral. La neurociencia abre la «caja negra» y encuentra genes, hormonas y neuronas, no un «yo» soberano.",
        },
        {
          type: 'paragraph',
          html: "Las decisiones combinan determinismo y azar cuántico, y ninguno es «libre». Experimentos de neuroimagen predicen pulsaciones antes de la conciencia de elegir. No hay yo permanente que «elija» deseos: solo un flujo de experiencias y un <span class=\"term\">yo narrativo</span> que inventa coherencia (Gazzaniga: hemisferio izquierdo como «interprete»).",
        },
        {
          type: 'concept-grid',
          items: [
            {
              "title": "Yo experimentador vs recordador",
              "description": "Kahneman: elegimos repetir tortura «larga» por memoria editada.",
              "icon": "🧠"
            },
            {
              "title": "Vida como narrativa",
              "description": "Liberalismo pide que cada uno escriba su drama; biología dice que es ficción biochemica.",
              "icon": "📖"
            },
            {
              "title": "Amenaza práctica",
              "description": "No la filosofía, sino apps y algoritmos que ignoran al libre individuo, desestabilizan democracia y mercado.",
              "icon": "⚡"
            }
          ],
        },
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "Tres amenazas prácticas al liberalismo. Primero, los humanos pierden valor militar y económico. Segundo, el sistema valora a la masa, no al individuo. Tercero, una élite de <span class=\"term\">superhumanos</span> optimizados reemplaza a la plebe.",
        },
        {
          type: 'paragraph',
          html: "La levée en masse y el sufragio femenino ligaron derechos a utilidad bélica e industrial. Hoy drones, ciber-guerra y algoritmos de trading hacen prescindible a masas de soldados y oficinistas. La <span class=\"term\">inteligencia</span> se desacopla de la <span class=\"term\">conciencia</span>: Watson diagnostica sin sentir, y los carros autónomos operan sin experiencia.",
        },
        {
          type: 'big-numbers',
          items: [
            {
              "value": "87%",
              "label": "Probabilidad (Harari cita) de que algoritmos superen capacidades humanas medias"
            },
            {
              "value": "50%",
              "label": "Profesiones en riesgo de automatización (estimaciones citadas)"
            },
            {
              "value": "Clase inútil",
              "label": "Nueva masa sin rol económico ni militar"
            }
          ],
        },
        {
          type: 'paragraph',
          html: "Algoritmos externos pueden «hackear» deseos mejor que el yo introspectivo (Google, wearables, «quantified self»). La medicina ya delega en sensores e IA (páncreas artificial con iPhone). El riesgo es optimizar pocos «deus» y abandonar vagones de tercera clase, como en las colonias del s. XIX.",
        },
        {
          type: 'key',
      ...
      blocks: [
        {
          type: 'paragraph',
          variant: 'lead',
          html: "El <span class=\"term\">dataísmo</span> ve el universo como flujos de datos. El valor de cualquier fenómeno equivale a su contribución al procesamiento. Une biología algorítmica (Darwin) e informática (Turing): organismos y máquinas obedecen las mismas matemáticas.",
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          html: "Google detecta epidemias antes que la OMS si accede a búsquedas. Los coches compartidos algorítmicos podrían reemplazar propiedad privada. El dataísmo invierte la pirámide del conocimiento: humanos ya no destilan datos en sabiduría, sino que ceden a Big Data. «Conócete a ti mismo» pasa de introspección a monitorización biométrica.",
        },
        {
          type: 'paragraph',
  ...
  {
    "title": "Homo deus",
    "description": "Proyección humano mejorado biotecnológicamente; sucesor del sapiens con capacidades casi divinas."
  },
  {
    "title": "Antropoceno",
    "description": "Era geológica donde Homo sapiens es la principal fuerza que transforma la biosfera (~70.000 años)."
  },
  {
    "title": "Ficción intersubjetiva",
    "description": "Entidad (dinero, nación, derecho) existente solo en creencia colectiva pero con poder real."
  },
  {
    "title": "Humanismo",
  ...
  },
  {
    ...
    "description": "Pilar liberal cuestionado por neurociencia: decisiones = bioquímica determinista/aleatoria."
  },
  {
    "title": "Desacoplamiento",
    "description": "Separación de inteligencia y conciencia; IA útil sin sentir."
  },
  {
    "title": "Clase inútil",
    "description": "Masas humanas sin valor económico/militar en economía algorítmica."
  },
  {
    "title": "Tecno-humanismo",
    "description": "Upgrade del sapiens para competir con IA (genética, interfaces cerebro-máquina)."
  },
  {
    "title": "Dataísmo",
    "description": "Ideología que maximiza flujo y procesamiento de datos por encima de humanos o dioses."
  }
],
  chronology: [
  {
    "year": "~70.000 a",
    "text": "Revolución cognitiva: lenguaje de ficciones compartidas."
  },
  {
    "year": "~12.000 a",
    "text": "Revolución agrícola: ciudades, mitos ampliados."
  },
  {
    "year": "~5.000 a",
  ...
  {
    "year": "1692–94",
    "text": "Hambrunas masivas en Francia (~15% muertes)."
  },
  {
    "year": "1789",
    "text": "Revolución francesa: derechos universales y levée en masse."
  },
  {
    "year": "1884",
  ...
  {
    "year": "1918",
    "text": "Gripe española: ~50–100 M muertes; WWI ~40 M."
  },
  {
    "year": "1979",
    "text": "OMS declara viruela erradicada."
  },
  {
    "year": "1981",
  ...
  {
    "year": "2013",
    "text": "Muerte de Aaron Swartz; debate libertad de información."
  },
  {
    "year": "2016",
    "text": "Contexto de publicación: liberalismo global bajo presión algorítmica."
  }
],
  figures: [
  {
    "name": "Yuval Noah Harari",
    "role": "Historiador; autor de Sapiens y Homo Deus; tesis sobre futuro post-humanista."
  },
  {
    "name": "Charles Darwin",
  ...
  {
    "name": "S. N. Goenka",
    "role": "Maestro de meditación; dedicatoria del libro (1924–2013)."
  },
  {
    "name": "Michael Gazzaniga",
    "role": "Neurocientífico; «interprete» del hemisferio izquierdo en pacientes split-brain."
  },
  {
    "name": "Daniel Kahneman",
    "role": "Yo experimentador vs yo recordador; economía del comportamiento."
  },
  {
    "name": "Aaron Swartz",
    "role": "Hacker y activista; mártir simbólico del dataísmo (1990–2013)."
  },
  {
    "name": "Friedrich Hayek",
    "role": "Economista; mercado como procesador distribuido de información."
  },
  {
    "name": "Alan Turing",
    "role": "Fundamentos de computación; algoritmos electrónicos vs bioquímicos."
  }
],
  closing: {
  ...
  "La religión del futuro podría venerar el flujo de información más que la experiencia humana, y quien controle el filtro tendrá el poder que antes tenía quien controlaba la verdad."
    ...
    highlight: "Las mismas herramientas que prometen cumplir ese sueño humanista pueden vaciar al humano libre que lo soñó.",
  },
  footer: {
