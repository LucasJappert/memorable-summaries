...
export const selfishGene: BookSummary = {
  ...
  sections: [
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "Las máquinas de supervivencia comenzaron como receptáculos pasivos; cuando el caldo orgánico se agotó, plantas explotaron la luz solar y animales explotaron a las plantas (o a otros animales). Ambas ramas evolucionaron cuerpos pluricelulares — colonias de genes."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          html: "El comportamiento parece teleológico — como el regulador de Watt con <span class=\"term\">retroalimentación negativa</span>. Los animales aprenden (memoria) y, en algunos casos, son conscientes; pero podemos analizar comportamiento «como si» tuviera propósito sin asumir consciencia."
        },
        {
          type: "paragraph",
        ...
        {
          type: "key",
          html: "Los animales son <span class=\"key-term\">máquinas génica</span> — vehículos activos programados para preservar replicadores, con cerebros que coordinan músculos mediante computación biológica."
        }
      ]
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "<span class=\"person\">Konrad Lorenz</span> enfatizó la ritualización de las peleas animales; Dawkins señala que la violencia inter-específica existe. La respuesta general: matar rivales tiene costos (tiempo, energía, riesgo de contraataque) y puede beneficiar a un tercero competidor. La pugnacidad selectiva — esperar, crecer, elegir momentos — puede ser mejor estrategia."
        },
        {
          type: "paragraph",
      ...
      blocks: [
        {
          type: "paragraph",
          variant: "lead",
          html: "La planificación familiar humana es decisional; en animales es programación instintiva sobre cuántos hijos tener y cuándo. Los genes «programan» tamaño de camada, intervalos reproductivos y inversión por cría según el entorno."
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "La asimetría fundamental: los gametos masculinos (esperma) son pequeños y numerosos; los femeninos (óvulos) son grandes y escasos. De la isogamia evolucionaron estrategias «honesta» (óvulo, gran inversión) y «explotadora» (esperma, móvil y barato). Los machos tienden a copular ampliamente; las hembras son el factor limitante."
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          html: "Los organismos existen porque los genes se benefician de agruparse en vehículos cooperativos grandes. El fenotipo extendido disuelve la tensión: el cuerpo es herramienta del gen; las herramientas pueden extenderse más allá de la piel."
        },
        {
          type: "key",
  ...
  closing: {
    ...
    lines: [
      ...
      "pero podemos rebelarnos contra ellos",
