...
title_es: "La realidad no es lo que parece"
...
| id | num | label |
|----|-----|-------|
| prefacio | 00 | Caminando junto a la orilla |
| cap1 | 01 | Granos |
...
| cap10 | 10 | Agujeros negros cuánticos |
| cap11 | 11 | El fin del infinito |
| cap12 | 12 | Información |
| cap13 | 13 | Misterio |
...
<!-- paragraph lead -->
¿De qué trata este libro y qué imagen del mundo propone la gravedad cuántica? Rovelli responde como si caminara con un colega junto a la orilla, en una tarde de verano.
...
<!-- key -->
La realidad elemental no es el continuo espacio-tiempo de la intuición, sino una red de eventos cuánticos donde espacio y tiempo emergen de las interacciones.

<!-- bridge -->
Para entender por qué espacio y tiempo pueden ser granulares hay que recuperar la primera gran intuición científica: el atomismo de Mileto y Abdera.
...
<!-- paragraph lead -->
¿De dónde viene la idea de que la realidad está hecha de «granos» indivisibles y por qué sigue siendo central hoy?

<!-- paragraph -->
En <span class="num">~450 a.C.</span>, según la tradición, <span class="person">Leucipo</span> huyó de Mileto hacia Abdera y fundó allí la escuela atomista. Junto con <span class="person">Demócrito</span> concibió un universo de átomos en el vacío: indivisibles, sin color ni sabor. «Por convención dulce, por convención amargo… pero en verdad átomos y vacío.»

<!-- paragraph -->
Demócrito argumentó contra el continuo, porque puntos sin extensión no componen extensión. <span class="person">Zenón</span> había señalado la paradoja de Aquiles y la tortuga. Leucipo respondió que nada arbitrariamente pequeño existe: la materia tiene límite de división. Hoy sabemos que al dividir agua llegamos a una molécula y paramos.

<!-- paragraph -->
En <span class="num">1897</span>, <span class="person">Ernst Mach</span> declaró en Viena: «¡No creo que existan los átomos!». En <span class="num">1905</span>, <span class="person">Albert Einstein</span> demostró su existencia con el movimiento browniano. Las fluctuaciones en granos de polen revelaron moléculas finitas en número y tamaño. Lucrecio, redescubierto por Poggio en 1417, había anticipado esa prueba «viva» con los motes en un rayo de sol.

<!-- key -->
Lo continuo es contradictorio. La materia, y por extensión lógica el espacio, tiene estructura granular que la física moderna confirma desde Demócrito hasta la longitud de Planck.

<!-- bridge -->
El atomismo necesitó la tradición clásica y las matemáticas para convertirse en física moderna.
...
<!-- paragraph lead -->
¿Cómo pasamos del cosmos aristotélico al mundo newtoniano de partículas y fuerzas, y qué cambio conceptual abrió la puerta al siglo XX?
...
<!-- key -->
Einstein revoluciona la ontología al mostrar que el espacio-tiempo no es escenario absoluto sino campo gravitatorio dinámico y relacional.

<!-- bridge -->
La mecánica cuántica es el otro pilar del siglo XX: igualmente exitosa, pero conceptualmente opaca y aparentemente incompatible.
...
<!-- paragraph lead -->
¿Qué pasa con el tiempo cuando espacio y gravedad son cuánticos, y cómo se calculan procesos sin <em>t</em>?

<!-- paragraph -->
Lucrecio ya advertía que el tiempo no es separable del movimiento. La ecuación Wheeler-DeWitt no contiene <em>t</em>. Espacio y tiempo emergen del campo gravitatorio cuántico. Galileo midió el péndulo con su pulso: nunca medimos tiempo solo, sino correlaciones A(B), B(C).

<!-- paragraph -->
Newton admitió que <em>t</em> es suposición útil, no observable directo. A escala de Planck no hay orden global de instantes: hay cambio ubiquo, pero sin director de orquesta. El tiempo macroscópico probablemente surge de promedios térmicos (<span class="term">tiempo térmico</span>: flecha ligada a disipación y calor).

<!-- paragraph -->
Al calcular procesos, incluimos un trozo de espacio-tiempo en el propio proceso, como el sushi enrollado en sí mismo. Sumamos sobre <span class="term">spinfoams</span> (espumas de espín: historias de redes de espín). El mundo son campos cuánticos covariantes sobre sí mismos, sin contenedor externo. Kant acertó en lo relacional, pero erró al tomar el espacio-tiempo newtoniano como <em>a priori</em>.
...
<!-- paragraph lead -->
¿Qué ocurrió en el origen del universo y puede haber existido algo antes del Big Bang?
...
<!-- bridge -->
¿Cómo sabremos si esta imagen es correcta? Hace falta distinguir pistas de evidencia fuerte y buscar señales observables.
...
<!-- paragraph lead -->
¿Qué aporta la gravedad cuántica a la física de los agujeros negros y cómo podría testearse?
...
| value | label |
|-------|-------|
| c | Velocidad máxima (relatividad especial) |
| ℏ | Acción/información mínima (mecánica cuántica) |
...
<!-- paragraph lead -->
¿Qué papel juega la información en la física fundamental y cómo puede reemergir el tiempo sin contradecir su ausencia básica?
...
<!-- paragraph lead -->
¿Qué grado de certeza tenemos sobre esta imagen del mundo y cómo convivir con lo desconocido?

<!-- paragraph -->
En el <em>Fedón</em>, Sócrates dice que la Tierra es esférica… «No estoy seguro.» La ciencia no ofrece certezas absolutas sino las mejores respuestas provisionales. Su fiabilidad viene de la apertura a corrección: Einstein corrigió a Newton.

<!-- paragraph -->
La ciencia desconfía de quien posee «La Verdad», y por eso choca a veces con la religión. Demócrito sostenía que «La verdad está en las profundidades». Aceptar incertidumbre puede asustar. Algunos prefieren certezas reconfortantes aunque infundadas.
...
<!-- key -->
La ciencia no da certezas absolutas. La conciencia de la ignorancia, no la fe en respuestas definitivas, hace fiable el conocimiento y mantiene viva la aventura.
...
| year | text |
|------|------|
| ~VI–V a.C. | Mileto, atomismo, paradojas de Zenón |
| 450 a.C. | Leucipo → Abdera; 494 a.C. destrucción de Mileto |
| 1417 | Poggio redescubre a Lucrecio |
| 1600 | Kepler; Galileo mide caída ~9,8 m/s² |
| 1900 | Planck; 1905: Einstein (átomos, relatividad especial, fotones) |
| 1915 | Relatividad general; 1917: cosmología Einstein (3-esfera) |
...
| ~14 mil millones de años | Big Bang / posible Big Bounce |
...
| name | role |
|------|------|
| Leucipo / Demócrito | Atomismo: átomos y vacío, sin finalismo |
| Lucrecio | *De rerum natura*: salva el espíritu atomista para el Renacimiento |
| Platón / Aristóteles | Matemáticas del cosmos; física cualitativa válida |
