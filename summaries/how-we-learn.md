...
|------|-------|-------------|
| 🎯 | Modelo interno | Representación mental que predice y da sentido a los sentidos. |
| 🔧 | Parámetros | Ajuste sináptico o cognitivo tras error (prismas, fonemas). |
| 📉 | Gradiente | Cada error indica cómo corregir el modelo (descenso de gradiente). |

<!-- key -->
Las siete definiciones convergen: aprender es ajustar un modelo jerárquico minimizando sorpresa.
...
<!-- key -->
Homo sapiens combina dos sistemas: reconocimiento rápido (tipo red profunda) y razonamiento simbólico consciente.
...
<!-- key -->
Los bebés son científicos estadísticos: simulan, predicen y se sorprenden ante violaciones.
...
<!-- key -->
Aprender es cambiar sinapsis bajo reglas hebbianas moduladas por emoción y atención.
...
<!-- key -->
La calidad del feedback determina la velocidad de aprendizaje.
...
<!-- highlight -->Atención, compromiso activo, feedback y consolidación —incluido el sueño— son los cuatro pilares de toda enseñanza eficaz.<!-- /highlight -->
