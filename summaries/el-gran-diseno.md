...
| prefacio | 00 | La cuestión última |
| cap1 | 01 | El misterio del ser |
| cap2 | 02 | Las reglas de la ley |
| cap3 | 03 | ¿Qué es la realidad? |
| cap4 | 04 | Historias alternativas |
| cap5 | 05 | La teoría de todo |
| cap6 | 06 | Escogiendo nuestro universo |
...
|------|-------|-------------|
| ⚖️ | Leyes como regularidades | Patrones matemáticos descubiertos por la observación, no mandatos de un diseñador. |
| 🌀 | Espacio-tiempo dinámico | La gravedad curva la geometría del cosmos; el tiempo fluye distinto según la velocidad. |
| ❓ | Tres preguntas abiertas | Por qué hay leyes, por qué estas y por qué el universo las sigue. |
...
| icon | title | description |
|------|-------|-------------|
| 🔗 | Cuatro fuerzas | Gravedad, electromagnetismo, nuclear débil y nuclear fuerte; objetivo de la unificación. |
| 🎻 | Teoría de cuerdas | Partículas como vibraciones en dimensiones extra; cinco versiones unificadas en M. |
| 🗺️ | Familia de modelos | La teoría M es un atlas de teorías solapadas, no una sola ecuación para todo. |
...
| value | label |
|-------|-------|
| ~10⁵⁰⁰ | Configuraciones posibles en el paisaje de la teoría M |
| ~1/1.000M | Asimetría materia-antimateria que dejó el universo visible |
...
<!-- key -->
La ciencia responde por qué hay algo en lugar de nada: la <span class="key-term">creación espontánea</span> hace innecesario a un diseñador divino.
...
| title | description |
|-------|-------------|
| Realismo dependiente del modelo | Solo existe la realidad descrita por un modelo que predice las observaciones; no hay imagen única del mundo. |
| Suma de historias | Formulación de Feynman: un sistema recorre todos los caminos posibles y la observación selecciona probabilidades. |
| Teoría M | Familia de teorías unificadas con 11 dimensiones que cubren distintos dominios físicos como mapas solapados. |
| Multiverso | Conjunto de universos con leyes y constantes distintas, predicción de la cosmología cuántica moderna. |
| Principio antrópico débil | Observamos un universo compatible con la vida porque solo en uno así podríamos existir para preguntarlo. |
| Creación espontánea | Un universo puede surgir de la nada sin coste energético neto, guiado por leyes como la gravedad. |
| Ajuste fino | Las constantes fundamentales caen en rangos estrechísimos que permiten átomos, estrellas y química vital. |
| Leyes de la naturaleza | Regularidades matemáticas descubiertas por la ciencia, no decretos de un legislador divino. |
...
| year | text |
|------|------|
| ~600 a.C. | Tales y Pitágoras buscan leyes naturales sin dioses para cada fenómeno. |
| 1543 | Copérnico propone el modelo heliocéntrico como alternativa al geocéntrico de Ptolomeo. |
| 1687 | Newton publica las leyes del movimiento y la gravitación universal. |
| 1915 | Einstein completa la relatividad general: la gravedad es curvatura del espacio-tiempo. |
| 1920s | Nace la mecánica cuántica; Heisenberg formula el principio de incertidumbre. |
| 1960s | Se unifican electromagnetismo y fuerza débil en la teoría electrodébil. |
| 1970 | Conway crea el Juego de la Vida, ilustración de complejidad desde reglas simples. |
| 1980s | Surge la teoría de cuerdas; Feynman populariza la suma de historias. |
| 1995 | Se propone la teoría M, unificando cinco versiones de cuerdas en 11 dimensiones. |
| 2010 | Hawking y Mlodinow publican El gran diseño con la tesis del multiverso y la creación espontánea. |
...
| name | role |
|------|------|
| Stephen Hawking | Cosmólogo; teoría M, agujeros negros y creación espontánea del universo. |
| Leonard Mlodinow | Físico teórico; coautor y divulgador de la nueva imagen cosmológica. |
| Richard Feynman | Reformuló la cuántica con la suma de historias; enfoque intuitivo del libro. |
| Albert Einstein | Relatividad general; preguntó si Dios tuvo elección al crear el universo. |
| Werner Heisenberg | Principio de incertidumbre; límites fundamentales del conocimiento simultáneo. |
| Fred Hoyle | Predijo la resonancia del carbono que hace posible la química de la vida. |
| John Conway | Creador del Juego de la Vida; metáfora de leyes simples y complejidad emergente. |
| Pierre-Simon Laplace | Visión determinista del universo gobernado por leyes completas. |
