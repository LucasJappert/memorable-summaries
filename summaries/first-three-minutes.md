...
title_es: "Los tres primeros minutos"
...
| cap1 | 01 | Introducción: el gigante y la vaca |
| cap2 | 02 | La expansión del universo |
| cap3 | 03 | El fondo de radiación cósmica de microondas |
| cap4 | 04 | Receta para un universo caliente |
| cap5 | 05 | Los tres primeros minutos |
| cap6 | 06 | Una digresión histórica |
| cap7 | 07 | El primer centésimo de segundo |
...
<!-- paragraph lead -->
¿Por qué vale la pena escribir ahora un libro sobre el universo temprano?
...
<!-- paragraph -->
En la última década había surgido un «modelo estándar» ampliamente aceptado del universo temprano. Por primera vez se podía decir con alguna confianza qué temperatura tenía el cosmos al final del primer segundo. También se conocían su densidad y composición química al final del minuto o del año. Esa posibilidad de calcular numéricamente era lo que Weinberg quería transmitir.
...
<!-- key -->
Es el momento oportuno para contar el universo temprano porque existe un modelo estándar que permite calcular numéricamente sus condiciones desde el primer segundo en adelante.

<!-- bridge -->
El prefacio delimita el alcance; el capítulo 1 presenta en síntesis ese modelo estándar cuyos fundamentos desarrollará el resto del libro.
...
<!-- paragraph lead -->
¿Cómo llegamos al modelo estándar del universo temprano y por qué desplazó teorías filosóficamente más atractivas, como el estado estacionario?

<!-- paragraph -->
La <span class="term">Edda menor</span> (mitos nórdicos compilados ~1220 por <span class="person">Snorri Sturleson</span>) explica el origen con Ymer, la vaca Audhumla y la sal. Cada respuesta exige una nueva complicación. No podemos renunciar a la cosmogonía científica. Durante décadas, sin embargo, el estudio del universo temprano pareció indigno de un científico respetable porque faltaba base observacional y teórica.
...
<!-- key -->
La cosmogonía ganó respetabilidad porque un modelo estándar del universo temprano impuso consenso por datos empíricos, no por mandarines ni preferencias filosóficas.

<!-- bridge -->
El capítulo 1 resume el modelo; el capítulo 2 reconstruye la primera pila empírica: la expansión de las galaxias.
...
<!-- paragraph lead -->
¿Qué nos dicen las observaciones sobre el movimiento de las galaxias y qué implica eso sobre el origen del universo?
...
<!-- key -->
La impresión de cielo fijo es falsa: las galaxias se apartan proporcionalmente a su distancia, lo que exige un pasado denso donde no existían galaxias, estrellas ni átomos.

<!-- bridge -->
Si el universo estuvo más caliente y denso, la luz dominante debió dejar un fondo detectable hoy: el capítulo 3 trata esa radiación.
...
<!-- key -->
El ruido isotrópico de ~3 K es radiación fósil de un universo en equilibrio térmico y fija el ratio crucial de fotones a partículas nucleares (~10⁹).

<!-- bridge -->
Con expansión, CMB y equilibrio térmico, el capítulo 4 puede escribir la receta de ingredientes del universo caliente.
...
<!-- paragraph lead -->
¿Qué ingredientes y qué parámetros conservados definen el universo caliente en equilibrio térmico?

<!-- paragraph -->
Por encima de temperaturas umbral, colisiones de fotones crean pares partícula-antipartícula (E=mc²). La temperatura escala con el tamaño del universo. Por ejemplo, electrones y positrones aparecen en masa por encima de ~<span class="num">6×10⁹ K</span>. En equilibrio térmico, la cantidad de cada especie queda fijada por creación y aniquilación mutuas.

<!-- paragraph -->
Cuando materia y antimateria fueran exactamente iguales, solo quedaría radiación. Estamos aquí porque hubo un exceso minúsculo, una partícula extra por cada mil millones, sin explicación satisfactoria. La población de neutrinos se infiere, no se observa directamente. La era de radiación pura empieza tras los primeros minutos, no desde t=0.

<!-- paragraph -->
En equilibrio térmico bastan tres cantidades conservadas más la temperatura. La <span class="term">carga eléctrica</span> (debe ser cero) debe cancelarse en total. El <span class="term">número bariónico</span> (protones y neutrones menos antipartículas) ronda ~<span class="num">10⁻⁹</span> por fotón. El <span class="term">número leptónico</span> (electrones, muones, neutrinos) es pequeño, por analogía. Sus densidades por fotón quedan fijas de una vez.

<!-- paragraph -->
En conjunto, la receta incluye carga cero, bariones ~10⁻⁹ por fotón y leptones inciertos pero pequeños. La temperatura escala como 3 K multiplicado por el cociente entre el tamaño actual y el entonces. Después basta dejar evolucionar el universo en expansión.

<!-- concept-grid -->
| icon | title | description |
| ---- | ----- | ----------- |
| ⚡ | Umbral térmico | Por encima de mc²/k_B, fotones crean pares materia-antimateria en equilibrio. |
| 📊 | Tres conservadas | Carga, bariones y leptones reducen la arbitrariedad de la receta cosmológica. |
| 🌡️ | Era radiación | Tras nucleosíntesis, radiación domina hasta ~700.000 años y recombinación. |

<!-- key -->
El contenido del universo temprano queda determinado por equilibrio térmico más tres cantidades conservadas cuyas densidades por fotón fijan la receta.

<!-- bridge -->
Con la receta en mano, el capítulo 5 reconstruye cuadro a cuadro los primeros tres minutos.
...
<!-- paragraph lead -->
¿Qué ocurrió, paso a paso, en los primeros tres minutos del universo?

<!-- paragraph -->
Weinberg reconstruye cuadro a cuadro desde ~<span class="num">10⁻² s</span> y ~<span class="num">10¹¹ K</span>, por debajo de los umbrales de mesones π. En el primer instante hay una sopa de electrones, positrones, neutrinos y fotones en equilibrio perfecto. Hay ~1 protón o neutrón por mil millones de fotones, y protones y neutrones están ~50-50.

<!-- paragraph -->
A ~<span class="num">0,11 s</span> y 3×10¹⁰ K, la proporción es 38 % neutrones y 62 % protones. A ~<span class="num">1 s</span>, los neutrinos se desacoplan y siguen expandiéndose sin interactuar.

<!-- paragraph -->
A ~<span class="num">14 s</span> y 3×10⁹ K, la aniquilación e⁺e⁻ calienta los fotones. El «cuello de botella del deuterio» impide la nucleosíntesis porque el D se destruye al formarse. A ~<span class="num">3 min 2 s</span> y 10⁹ K, casi no quedan e⁺e⁻.
...
| value | label |
| ----- | ----- |
| ~26 % | Helio primordial (predicción central) |
| ~10⁹ | Fotones por partícula nuclear |
| 3 min 46 s | Inicio de nucleosíntesis primordial |

<!-- key -->
Siguiendo expansión y enfriamiento cuadro a cuadro, equilibrio térmico y reacciones nucleares producen ~22–28 % de helio primordial, predicción verificable que consolida el modelo estándar.

<!-- bridge -->
Si la teoría ya permitía predecir el CMB, ¿por qué nadie lo buscó antes de 1965? El capítulo 6 explora esa omisión histórica.
...
<!-- paragraph lead -->
¿Por qué el fondo de microondas no se buscó años antes de su descubrimiento fortuito?
...
<!-- key -->
La detección del CMB en 1965 fue accidental porque, pese a predicciones teóricas, nadie emprendió una búsqueda sistemática: fallas de comunicación, prestigio de la nucleosíntesis estelar y resistencia al universo temprano.

<!-- bridge -->
Tras la historia reciente, el capítulo 7 retrocede más allá del primer fotograma del capítulo 5, hacia el centésimo de segundo.
...
<!-- paragraph lead -->
¿Qué podemos saber sobre el primer centésimo de segundo y el «verdadero» comienzo, y qué queda fuera de alcance?
...
<!-- paragraph -->
La transición de fase <span class="term">electrodébil</span> (~<span class="num">3×10¹⁵ K</span>, Weinberg–Salam, Kirzhnits–Linde) unificó fuerzas débiles y electromagnéticas y luego se «congeló». La gravedad cuántica importa a ~<span class="num">10³² K</span> (~<span class="num">10⁻⁴³ s</span>): ahí falla toda extrapolación. Posible universo sin singularidad (rebote), y el tiempo cero absoluto puede ser límite lógico. Quarks confinados no son observables libres, y radiación gravitacional de fondo ~<span class="num">1 K</span> sería indetectable.
...
<!-- key -->
Antes del centésimo de segundo un velo de física de partículas impide calcular con confianza, pero el equilibrio térmico del primer segundo borra la memoria de condiciones iniciales anteriores para todo lo observable hoy.

<!-- bridge -->
Si el pasado remoto es opaco, el capítulo 8 proyecta el futuro lejano: expansión eterna o colapso final.
...
<!-- paragraph lead -->
¿Hacia dónde va el universo y qué sentido tiene la existencia humana frente a ese destino?

<!-- paragraph -->
Si la densidad supera la crítica, el universo es finito y recontraerá. En el escenario de densidad igual al doble de la crítica y H₀ ~15 km/s/Mly, el universo tiene una edad de ~<span class="num">10.000 millones de años</span>. Entonces expandiría ~<span class="num">50.000 millones</span> más y luego colapsaría.

<!-- paragraph -->
En recontracción el cielo dominaría radiación (~<span class="num">300 K</span> al 1 % del tamaño actual). Galaxias, átomos y núcleos se desharían en calor creciente. Serían los primeros tres minutos a la inversa.

<!-- paragraph -->
Incertidumbres del capítulo 7 (anisotropía, gravedad cuántica) invalidarían predicciones del «último centésimo de segundo». Algunos esperan un «rebote» cosmológico, con Ragnarök en la Edda como analogía, pero la entropía creciente por viscosidad bulk dificulta ciclos infinitos sin inicio. El modelo oscilante evita Génesis pero choca con el ratio fotones/nucleones finito.

<!-- paragraph -->
Weinberg admite tentación de creer que la vida humana estaba «incorporada desde el principio». Volando sobre Wyoming, el paisaje parece acogedor, pero el cosmos es hostil. Evolucionó desde condiciones insospechadas hacia frío eterno o calor intolerable. Cuanto más comprensible parece el universo, más carente de propósito.

<!-- quote -->
> «El esfuerzo por entender el universo es una de las pocas cosas que elevan la vida humana del absurdo hacia la tragedia.»
> — Steven Weinberg

<!-- key -->
El destino del universo depende de si la densidad supera la crítica: expansión eterna hacia frío y vacío, o contracción que deshace galaxias, átomos y núcleos repitiendo a la inversa los primeros tres minutos.

<!-- bridge -->
El epílogo cierra el arco temporal; el postfacio resume qué cambió en cosmología desde 1976 sin derribar el esquema central.
...
<!-- paragraph lead -->
¿Qué ha cambiado en cosmología desde la publicación original del libro?
...
<!-- key -->
Desde 1976 el esquema general se mantiene. El progreso llena vacíos observacionales y empuja la teoría hacia el universo ultratemprano (GUT, inflación, origen de bariones, masa oscura).
...
| title | description |
| ----- | ----------- |
| Modelo estándar del universo temprano | Big bang con receta específica de contenidos; distinto del término genérico «big bang». |
| Principio cosmológico | Homogeneidad e isotropía a escala de cúmulos; fundamenta la ley de Hubble. |
| Equilibrio térmico | Colisiones fijan distribuciones de partículas; borra memoria de condiciones iniciales detalladas. |
| Radiación de cuerpo negro (Planck) | Distribución universal de energía vs longitud de onda; clave para interpretar el CMB. |
| Ratio fotones / nucleones (~10⁹) | Parámetro observacional crucial, medido vía CMB, que gobierna nucleosíntesis y abundancias. |
| Nucleosíntesis primordial | Ensamblaje de H, He y trazas en los primeros minutos; helio ~22–28 % es predicción central. |
| Constante / ley de Hubble | Velocidad de recesión proporcional a distancia; fija escala temporal del universo. |
| Cantidades conservadas | Carga, bariones y leptones reducen la arbitrariedad de la receta cosmológica. |
| Corrimiento al rojo cosmológico | Longitudes de onda estiradas proporcionalmente a la separación entre galaxias típicas. |
| Horizonte cósmico | Límite causal que encoge hacia el pasado y permite inferir el universo temprano. |
...
| year | text |
| ---- | ---- |
| ~1220 | Snorri Sturleson compila la Edda menor |
| 1842 | Doppler formula el efecto que lleva su nombre |
| 1868 | Espectroscopía estelar; Huggins aplica Doppler a estrellas |
| 1923 | Hubble resuelve M31 en estrellas Cefeidas |
| 1929 | Ley de Hubble: corrimiento al rojo proporcional a distancia |
| 1946 | Dicke fija límite &lt;20 K al fondo de microondas |
| 1948 | Alpher y Herman predicen CMB ~5 K |
| 1964–1965 | Penzias y Wilson detectan exceso de temperatura ~3,5 K |
| 1972–1976 | Globos Berkeley confirman cuerpo negro del CMB |
| 1973 | Libertad asintótica (Gross, Politzer, Wilczek); corrientes neutras |
| 1976 | Publicación original de *The First Three Minutes* |
| ~1981–1982 | Datos del postfacio: anisotropía CMB, inflación, masa oscura |
...
| name | role |
| ---- | ---- |
| Snorri Sturleson | Compila mitos nórdicos de cosmogonía (Edda menor) |
| Johann Christian Doppler | Efecto Doppler en ondas sonoras y luminosas · 1842 |
| Edwin Hubble | Resuelve naturaleza extragaláctica de nebulosas · ley de Hubble · 1923–1929 |
| Albert Einstein / Alexandre Friedmann | Relatividad general · modelos cosmológicos homogéneos e isotrópicos |
| George Gamow / Ralph Alpher / Robert Herman | Teoría del big bang · predicción del CMB ~5 K · 1948 |
| Arno Penzias / Robert Wilson | Descubrimiento fortuito del CMB · Holmdel · 1964–1965 |
| Robert Dicke / Jim Peebles / P. G. Roll / D. T. Wilkinson | Interpretación cosmológica del CMB · Princeton |
| Steven Weinberg | Autor · teoría electrodébil · unificación de fuerzas |
| Fred Hoyle / Halton Arp | Estado estacionario · crítica a interpretación del corrimiento al rojo |
| Alan Guth | Inflación y superenfriamiento · postfacio |
| Andrei Sakharov / Vera Rubin / G. de Vaucouleurs | Generación de bariones · rotación galáctica · velocidades peculiares |
