...
title_es: "Orígenes: Catorce mil millones de años de evolución cósmica"
...
| cap4 | 04 | Que haya oscuridad |
| cap5 | 05 | Que haya más oscuridad |
| cap6 | 06 | ¡Tensión en el cosmos! |
| cap7 | 07 | ¿Un universo o muchos? |
| cap8 | 08 | Descubriendo las galaxias |
| cap9 | 09 | El origen de la estructura |
| cap10 | 10 | Polvo al polvo |
| cap11 | 11 | Cuando los mundos eran jóvenes |
| cap12 | 12 | Planetas más allá del Sistema Solar |
| cap13 | 13 | Vida en el universo |
...
<!-- paragraph -->
Los humanos fascinan los orígenes por razones lógicas y emocionales. Pero cada avance revela que habitamos un <span class="term">grano de polvo cósmico</span> en los suburbios de una galaxia común, entre al menos <span class="num">100.000 millones de galaxias</span>. Los mitos de creación suelen pasar rápido del universo a la historia humana, como si fuéramos el centro.
...
|------|-------|-------------|
| ⚛️ | Era de quarks | Primeras fracciones de segundo: partículas elementales en equilibrio térmico violento. |
| 🔥 | Era de hadrones | Al enfriarse, los fotones ya no crean pares quark-antiquark; sobrevive una partícula de materia por cada mil millones de aniquilaciones. |
| 🌡️ | Nucleosíntesis | A ~2 minutos: 90% hidrógeno, 10% helio, trazas de deuterio y litio. |

<!-- big-numbers -->
| value | label |
|-------|-------|
| ~1 s | Fin de la era leptónica; un electrón por protón |
| ~2 min | Formación de núcleos ligeros |
| 380.000 años | Átomos estables; fotones liberados (CBR) |
...
| year | text |
|------|------|
| 1964 | Detección accidental de la CBR por Penzias y Wilson. |
| 1992 | COBE confirma fluctuaciones en la CBR. |
...
| icon | title | description |
|------|-------|-------------|
| 🌑 | Materia oscura | Masa invisible detectada solo por efectos gravitatorios en cúmulos y galaxias. |
| 🔭 | Cúmulo de Coma | Primer laboratorio donde la «masa faltante» resultó imposible de ignorar. |
| ⚖️ | MOND | Alternativa que modifica la gravedad a grandes distancias; la materia oscura sigue siendo la explicación dominante. |
...
<!-- paragraph lead -->
Dos métodos independientes para medir la <span class="term">constante de Hubble</span> (H₀) —velocidad de recesión por megaparsec— dan resultados discordantes: ~<span class="num">67</span> vs ~<span class="num">73</span> km/s/Mpc, una diferencia del ~10%.
...
<!-- paragraph -->
Antes del telescopio Hubble, los valores de H₀ divergían por factor 2 (50 vs 100). Que hoy la discordancia sea solo ~10% es progreso; pero si persiste, podría abrir nueva física más allá del modelo estándar.

<!-- timeline -->
| year | text |
|------|------|
| 1929 | Hubble establece la ley de expansión. |
| 1998 | Supernovas revelan aceleración y energía oscura. |
| 2010s– | «Tensión cosmológica»: H₀ local vs H₀ del CBR no concilian. |
...
<!-- paragraph -->
El <span class="term">principio antrópico</span> responde que solo en universos con parámetros compatibles con galaxias, estrellas y vida puede haber observadores. El <span class="term">multiverso</span> —infinitos universos con leyes y constantes aleatorias— explicaría por qué el nuestro tiene valores «apenas» aptos para vida, aunque la hipótesis es difícil de verificar.

<!-- concept-grid -->
| icon | title | description |
|------|-------|-------------|
| 🫧 | Inflación | Expansión exponencial inicial; explica planitud y semillas cuánticas. |
| 🌌 | Multiverso | Universos paralelos sin interacción; selección antrópica de constantes. |
| ⚖️ | Coincidencia Ω | Solo entre ~3 y ~50 mil millones de años post-Big Bang ΩM ≈ ΩΛ. |
...
| year | text |
|------|------|
| 1789 | Herschel cartografía nebulosas del hemisferio norte. |
| 1923 | Hubble identifica Cefeidas en Andrómeda. |
...
<!-- paragraph -->
Estrellas en fase de <span class="term">gigante roja</span> expulsan granos de polvo al espacio. En regiones como la nebulosa de Orión, miles de estrellas nacen de nubes de ~un millón de masas solares. Sin polvo y gas no habría segunda generación estelar ni elementos pesados para planetas y vida.
...
<!-- paragraph lead -->
Copérnico situó la Tierra entre los planetas del Sol; eso sugiere mundos innumerables con posibles habitantes. <span class="person">Giordano Bruno</span> pagó con la vida en <span class="num">1600</span> su defensa de mundos alienígenas.
...
<!-- paragraph lead -->
Solo conocemos un ejemplo de vida: la terrestre, basada en ADN. Sin comparaciones múltiples, la astrobiología infiere principios generales desde la química y la historia de la Tierra, evitando el <span class="term">antropomorfismo</span>.
...
<!-- paragraph -->
La detección masiva de exoplanetas inclina hacia el optimismo sobre vida abundante, pero cada término de Drake sigue incierto. Resultados negativos fortalecerían el pesimismo; positivos en el Sistema Solar sugerirían vida común en la galaxia.
...
<!-- paragraph -->
El carbono forma hasta cuatro enlaces débiles y versátiles; el silicio —favorito de la ciencia ficción— enlaza fuerte con oxígeno en rocas estables, poco apto para metabolismo acuoso. Vida alienígena probablemente también será <span class="term">basada en carbono</span>.
...
| icon | title | description |
|------|-------|-------------|
| 🔴 | Marte | Evidencia de agua antigua; búsqueda de biosfirmas y fósiles microbianos. |
| 🧊 | Europa / Encélado | Géiseres y océanos internos alimentados por calor de marea. |
...
<!-- paragraph lead -->
Para vida <em>compleja</em> hay que mirar exoplanetas: en el Sistema Solar solo se esperan formas primitivas. Con ~<span class="num">5.000 exoplanetas</span>, los dos primeros términos de Drake apuntan alto; los de habitabilidad, origen, inteligencia y longevidad civilizatoria siguen casi tan inciertos como antes.
...
<!-- paragraph -->
El <span class="term">SETI</span> busca señales de radio u ópticas artificiales sin éxito concluyente. Explorar la galaxia entera tardaría millones de años; la escucha electromagnética es el método viable. Detectar biosfirmas espectroscópicas en atmósferas exoplanetarias es la próxima frontera.
...
| title | description |
|-------|-------------|
| Big Bang | Expansión del universo desde estado caliente y denso; no una explosión en el espacio sino expansión del espacio mismo. |
| E = mc² | Equivalencia masa-energía; base de nucleosíntesis, estrellas y pares materia-antimateria. |
| Radiación cósmica de fondo (CBR) | Fotones liberados ~380.000 años post-Big Bang; hoy microondas a 2,73 K. |
| Materia oscura | Masa gravitatoria invisible; ~85% de la materia del universo. |
| Energía oscura | Energía del vacío que acelera la expansión; ~69% del contenido energético. |
| Constante de Hubble (H₀) | Tasa actual de expansión; objeto de la «tensión cosmológica». |
| Inflación cósmica | Expansión exponencial ultra-rápida en los primeros instantes. |
| Multiverso | Hipótesis de infinitos universos con parámetros distintos; explicación antrópica. |
| Exoplaneta | Planeta orbitando una estrella distinta del Sol; >5.000 catalogados. |
| Ecuación de Drake | Marco para estimar civilizaciones comunicativas en la galaxia. |
...
| year | text |
|------|------|
| 1610 | Galileo resuelve la Vía Láctea en estrellas con telescopio. |
| 1789 | Herschel construye el mayor telescopio de su época. |
| 1905 | Einstein publica E = mc² y relatividad especial. |
| 1915 | Einstein completa relatividad general y constante cosmológica. |
| 1929 | Hubble demuestra expansión del universo. |
| 1932 | Anderson descubre el positrón. |
| 1933 | Zwicky detecta materia faltante en el cúmulo de Coma. |
| 1964 | Penzias y Wilson detectan la CBR. |
| 1995 | Primer exoplaneta confirmado alrededor de estrella tipo solar. |
| 1998 | Supernovas tipo Ia revelan aceleración cósmica y energía oscura. |
| 2017 | Primera detección directa de ondas gravitacionales (LIGO/Virgo). |
| 2020s | Miles de exoplanetas; tensión en H₀; JWST imagen profunda del universo temprano. |
...
| name | role |
|------|------|
| Albert Einstein | Relatividad, E = mc², constante cosmológica · unificó espacio, tiempo y gravedad |
| Edwin Hubble | Ley de expansión · probó que Andrómeda es galaxia externa |
| Fritz Zwicky | Materia oscura en el cúmulo de Coma · astrofísico prolífico y polémico |
| Vera Rubin | Curvas de rotación galácticas · evidencia sistemática de materia oscura |
| Paul Dirac | Ecuación que predijo la antimateria |
| Carl Anderson | Descubridor experimental del positrón (1932) |
| Frank Drake | Ecuación de Drake · pionero del SETI |
| Immanuel Kant | Hipótesis nebular de formación planetaria |
| Neil deGrasse Tyson y Donald Goldsmith | Coautores de Origins; divulgación y síntesis interdisciplinaria |
