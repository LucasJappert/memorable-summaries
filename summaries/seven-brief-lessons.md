...
title_es: "Siete breves lecciones de física"
...
<!-- key -->
Conocer el universo cuántico no nos aleja de lo humano: nos sitúa en casa, hechos del mismo polvo estelar.
...
| title | description |
|-------|-------------|
| Relatividad general | Gravedad = curvatura del espaciotiempo; espacio y campo unificados. |
| Cuantos | Paquetes discretos de energía; la luz como fotones. |
| Mecánica cuántica | Probabilidad, saltos y realidad relacional entre interacciones. |
| Modelo Estándar | Teoría de partículas elementales y fuerzas, excepto gravedad. |
| Materia oscura | Masa gravitatoria no explicada por partículas conocidas. |
| Gravedad cuántica de bucles | Espacio granular; tiempo emergente de procesos locales. |
| Entropía | Desorden estadístico; flecha del tiempo termodinámica. |
| Radiación Hawking | Agujeros negros emiten calor por efectos cuánticos. |
| Big Bounce | Posible rebote cósmico previo al Big Bang. |
| Realidad relacional | Propiedades definidas por interacciones, no por substancias aisladas. |
...
| year | text |
|------|------|
| 1900 | Planck introduce cuantos de energía (cuerpo negro). |
| 1905 | Einstein: fotones, relatividad especial, movimiento browniano. |
| 1915 | Einstein completa relatividad general. |
| 1919 | Medición de desviación de luz estelar confirma Einstein. |
| 1920s | Bohr, Heisenberg, Schrödinger: mecánica cuántica madura. |
| 1930 | Expansión del universo observada. |
| 1960s–70s | Modelo Estándar de partículas; descubrimiento de CMB. |
| 1906 | Boltzmann muere; entropía estadística reconocida después. |
| 1970s | Teoría SU(5) propuesta; protón no se desintegra. |
| 2013 | Higgs boson detectado en LHC (CERN). |
| 2014–2016 | Rovelli publica lecciones (Adelphi / Riverhead). |
...
| name | role |
|------|------|
| Albert Einstein | Relatividad especial y general · Fotones |
| Max Planck | Origen de los cuantos (1900) |
| Niels Bohr | Modelo atómico · Copenhague |
| Werner Heisenberg | Matriz cuántica · Incertidumbre |
| James Clerk Maxwell | Campo electromagnético |
| Carl Friedrich Gauss | Geometría de superficies |
| Bernhard Riemann | Curvatura multidimensional |
| Murray Gell-Mann | Quarks · Modelo Estándar |
| Ludwig Boltzmann | Entropía estadística |
| Stephen Hawking | Radiación de agujeros negros |
...
<!-- highlight -->La ciencia no nos extrae del mundo: nos muestra de qué estamos hechos<!-- /highlight -->
