...
| 🔗 | Disciplinas entrelazadas | Genética, neurociencia, endocrina, desarrollo: un solo cuerpo de conocimiento. |
...
<!-- paragraph lead -->
El universo lineal permitía predecir <span class="term">X+1</span> desde <span class="term">X</span> con error proporcional —base del <span class="term">reduccionismo</span>. <span class="person">Edward Lorenz</span> (<span class="num">1963</span>) descubrió lo contrario: redondear <span class="num">0,506127</span> a <span class="num">0,506</span> desvió totalmente el clima simulado.

<!-- paragraph -->
Tres o más cuerpos interactuando (problema de tres cuerpos) vuelven impredecible el futuro: <span class="term">dependencia sensible de condiciones iniciales</span> y <span class="term">efecto mariposa</span>. Aun así, el sistema es determinista —caótico, no aleatorio.

<!-- paragraph -->
Automatons celulares (reglas locales tipo Conway) muestran patrones complejos imposibles de predecir reductivamente. No hay libre albedrío en esas grietas.

<!-- key -->
Caos = determinismo + impredecibilidad práctica, no libertad.
...
<!-- paragraph lead -->
Algunos buscan libre albedrío en sistemas caóticos biológicos: comportamiento complejo emergente de reglas simples. Sapolsky rechaza la inferencia: impredecibilidad no es autonomía.

<!-- paragraph -->
El cerebro puede ser sensible a condiciones iniciales, pero sigue siendo máquina causal. Confundir «no puedo predecir» con «nadie causó» es error lógico repetido en debates filosóficos.

<!-- key -->
Caos no inserta un agente libre en la ecuación.
...
<!-- key -->
Emerger no es flotar: sigue siendo tortugas.
...
<!-- key -->
Indeterminación cuántica ≠ elección responsable.
...
<!-- paragraph lead -->
Breve pausa narrativa en el libro: diálogo interno («my brain: click them / me: why? / my brain: you gotta») ilustra la dissociación entre impulsos neuronales y narrativa consciente de control.

<!-- paragraph -->
Refuerza que la voz que cree decidir llega después de procesos subterráneos — tono lúdico antes de preguntar si negar libre albedrío desata el caos social.

<!-- key -->
La conversación cerebro-yo resume el libro en tres líneas.
...
<!-- paragraph lead -->
Determinismo no implica estasis: cerebros cambian, comportamientos cambian. Plasticidad, terapia, hormonas, entorno —todo causal, nada libre.

<!-- paragraph -->
Sapolsky revisa mecanismos de cambio (extinción, aprendizaje, intervención social) compatibles con incompatibilismo. La pregunta «¿puede cambiar?» es distinta de «¿puede elegir libremente cambiar?».

<!-- key -->
Un mundo determinista puede ser un mundo donde las personas se transforman.
...
<!-- key -->
Sin libre albedrío no hay mérito absoluto ni culpa absoluta — hay causas, contención y compasión posible.
...
| Tortugas | Metáfora de causas en cadena sin causa flotante. |
| Libet / readiness potential | Actividad cerebral antes de la sensación de decidir. |
| Grit falso | Creer que carácter escapa a biología del PFC. |
| Caos determinista | Impredecible pero causal; no es libertad. |
| Emergencia | Propiedades nuevas del sistema sin agente libre. |
| Cuarentena | Modelo penal: contener peligro, no castigar merecidamente. |
| Suerte constitutiva | Genes, feto, infancia, cultura fuera de control personal. |
...
| year | text |
|------|------|
| 1321 | «Complot de los leprosos»; linchamientos en Francia/Alemania. |
| 1757 | Ejecución de Robert-François Damiens en París. |
| 1848 | Phineas Gage; lesión frontal y cambio de carácter. |
| 1936 | Último ahorcamiento público en EE. UU. (Rainey Bethea). |
| 1983 | Libet publica experimento de potencial de preparación. |
| 1994 | Crick: «solo un paquete de neuronas». |
...
| name | role |
|------|------|
| Robert M. Sapolsky | Autor; primatólogo y neurobiólogo, incompatibilista. |
| Benjamin Libet | EEG y debate sobre veto consciente. |
| Daniel Dennett | Compatibilista; «suerte se promedia», maratón vs. dash. |
| Derk Pereboom | Modelo de cuarentena penal. |
| Gregg Caruso | Cuarentena + determinantes sociales del crimen. |
| Edward Lorenz | Caos y efecto mariposa en meteorología. |
| Francis Crick | Determinismo duro citado en experimentos psicológicos. |
...
<!-- highlight -->Somos tortugas hasta el fondo; eso no impide cambiar cerebros, leyes ni compasión.<!-- /highlight -->
