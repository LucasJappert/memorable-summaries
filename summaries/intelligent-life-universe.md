...
|------|-------|-------------|
| ☁️ | Nubes moleculares | Hasta 10⁶ M☉; núcleos fríos donde nace el colapso gravitacional. |
| ⭐ | Secuencia principal | Fusión H→He en el núcleo; etapa estable de la mayoría de las estrellas. |
| 💥 | Supernova | Expulsión de elementos pesados; enriquece el medio para nuevas generaciones. |
...
| 🔄 | Migración joviana | Júpiteres desplazados hacia la estrella perturban planetas interiores. |
...
| icon | title | description |
|------|-------|-------------|
| ☢️ | Guerra y terrorismo | Mayor peligro actual: destrucción deliberada global. |
| 🌋 | Volcanismo extremo | Supervolcanes pueden alterar clima global. |
| ☄️ | Impactos | Programa Spaceguard identifica asteroides &gt;1 km. |
