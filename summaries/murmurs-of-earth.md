...
|------|-------|-------------|
| 📻 | Disco LP | Frank Drake sugirió un disco: información duradera, imágenes en audio y música. |
| 🎵 | Matemática y música | Relación pitagórica; quizá lenguaje universal para emociones humanas. |
| 🌍 | Público terrestre | Oliver: billones de terrícolas verán el mensaje; casi ningún extraterrestre. |

<!-- paragraph -->
El disco gira a <span class="num">16⅔</span> rpm para ~<span class="num">90</span> minutos de música. Debates nocturnos eligieron Bach, Beethoven, música étnica (Alan Lomax), blues de Louis Armstrong y la Cavatina de Beethoven como cierre emotivo. CBS Records obtuvo liberaciones de copyright «para fines extraterrestres».

<!-- key -->
El Disco Voyager es cápsula del tiempo cósmica: ciencia, arte, sonido y saludo en un solo artefacto físico.
...
<!-- paragraph lead -->
<span class="person">Frank Drake</span>, pionero del SETI, relata el desarrollo de técnicas de mensajería interestelar desde los años cincuenta. La convicción de vida más allá de la Tierra impulsa codificar información comprensible sin contacto previo.
...
<!-- paragraph -->
Siluetas y diagramas aseguran legibilidad si la decodificación de fotografías falla. Cada imagen fue debatida: ¿representa la diversidad humana? ¿Evita chauvinismo occidental? ¿Puede malinterpretarse? Lomberg jugó el papel de crítico alienígena en cada selección.
...
| value | label |
|-------|-------|
| 54+ | Idiomas humanos en el Disco |
| 1 | «Idioma» de ballena jorobada |
| 118 | Fotografías codificadas en el registro |

<!-- key -->
Decir «hola» al cosmos exigió diplomacia terrestre: la ONU, la ballena y la diversidad lingüística en minutos de audio.
...
<!-- paragraph -->
La secuencia alterna culturas y contrastes emocionales. Los últimos dos temas expresan soledad cósmica y anhelo de contacto —eco del mensaje principal del Disco.

<!-- quote -->
> «Para futuros tiempos y seres.»
...
<!-- key -->
Voyager es simultáneamente exploradora del sistema solar y mensajera al vacío entre las estrellas.
...
| title | description |
|-------|-------------|
| Disco de las Voyager | Registro fonográfico de cobre/dorado con sonido, imágenes y saludos; instrucciones en la cubierta. |
| Mensaje de Arecibo | Bitmap de 551 caracteres transmitido por radio en 1974; prueba de mensajería SETI. |
| Cápsula del tiempo | Comunicación con el futuro lejano; tradición desde Esarhaddon hasta la era espacial. |
| SETI | Búsqueda de inteligencia extraterrestre; escuchar es más plausible que dialogar a distancias interestelares. |
| Micrometeoritos | Principal amenaza al Disco en el vacío; la cubierta de aluminio mitiga el daño. |
| Lingua cosmica | Código basado en matemática y física para comunicar sin idioma compartido. |
...
| year | text |
|------|------|
| 1971–72 | Lanzamiento de Pioneer 10 y 11 con placas interestelares. |
...
| 1977 | Lanzamiento de Voyager 1 (5 sep) y 2 (20 ago); disco completado en mayo–junio. |
| 1979–81 | Voyager explora Júpiter y Saturno; posible ruta a Urano. |
...
| Frank Drake | SETI y mensaje de Arecibo; sugirió el disco fonográfico. |
| Jon Lomberg | Diseño y selección de las 118 imágenes codificadas. |
| Linda Salzman Sagan | Saludos en decenas de idiomas y coordinación ONU. |
| Ann Druyan | «The Sounds of Earth» y producción creativa del registro. |
| Timothy Ferris | Selección musical y asistencia en saludos de la ONU. |
| John Casani | Director del proyecto Voyager en JPL; encargó el mensaje. |
